  ...
  return (
    <form
      onSubmit={(e) => {
        ...
        setSearchParam("search", formData.get("search") as string);
      }}
      className=" border relative rounded-xl overflow-hidden mb-5 "
    >
      <span className="opacity-100 rounded-s-xl px-2 h-full absolute  flex items-center mb-1 ">
        <Search color="gray" />
      </span>
      <div className="flex">
        <input
        ...
        <button
          type="submit"
          className="bg-slate-500 px-11 hover:bg-slate-700 transition-all text-white text-lg"
        >
          search
        </button>
      </div>
